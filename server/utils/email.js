...
const emailToken = async (token, receiver, purpose) => {
  try {
    ...
    const output1 = `<p>Hello ${
      receiver.username
    }</p>Link for reset password: <a  href ="http://b2b.fixedtour.com/resetpassword/${token}"> <button>Reset</button></p><p>${
   ...
   ${
    ...
    <br>
    <br>
    Thank You for your login to <a href ="http://b2b.fixedtour.com"> fixedtour.com</a>
    <br>`
       : ""
   }
    ...
    <br>
    Click on <a href ="http://b2b.fixedtour.com/verifyemail/${token}">Verify Email</a>
    <br>
    <br>
    ...
    Team 
    <br>
    <a href ="http://b2b.fixedtour.com"> fixedtour.com</a>`;
